...
%%---------------------------------------------------------------------------------%%
      % chemcial source terms calculation
      dtTotal = 0;
      dt1 = dt;
      nChemSteps = 0;
      rr1 = zeros(N+1,1);
      ...
      while (dtTotal < dt)
          ...
          tmp_m1 = m1;
          tmp_m2 = m2;
          err_R1 = tmp_m1 - tmp_m01;
          err_R2 = tmp_m2 - tmp_m02;
...
%%---------------------------------------------------------------------------------%%       
  ...
  if (mod(t,t_write_interval)<1e-6)
      ...
      fprintf('%1.4e  %1.4e  %1.4e  %d  %d\n',err_mass,err_cum_mass,err_mdot,nIter,nChemSteps);
  end  
...
Time_data=[Time V_oil V_water V_reactor reactor_single_phase Mdot_out ...
